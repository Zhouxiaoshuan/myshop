    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image', models.ImageField(blank=True, null=True, upload_to='static/good/image/', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField(default='', help_text='品牌描述', max_length=200, verbose_name='平拍描述')),
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(limit_choices_to=models.Q(category_type=2), on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCategory', verbose_name='商品类目'),
        ),
        migrations.AddField(
            model_name='banner',
            name='goods',
