# Generated by Django 2.1.7 on 2019-04-01 16:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_SUCCESS', '交易成功'), ('TRADE_CLOSED', '交易关闭'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_FINISHED', '交易结束'), ('PAYING', '待支付')], default='paying', max_length=30, verbose_name='订单状态')),
