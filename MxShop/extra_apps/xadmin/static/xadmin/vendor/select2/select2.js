...
(function ($, undefined) {
     ...
     *
     * If the object form is used ti is assumed that it contains 'data' and 'text' keys. The 'data' keys should contain
     * an array of objects that will be used as choices. These objects must contain at least an 'id' keys. The 'text'
     * keys can either be a String in which case it is expected that each element in the 'data' array has a keys with the
    ...
    function local(options) {
        ...
        if (dataItem.text) {
            text = dataItem.text;
            // if text is not a function we assume it to be a keys name
            if (!$.isFunction(text)) {
